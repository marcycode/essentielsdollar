...
const Cutleries = () => {
    ...
    <div className="mb-20">
      <div className="shop">
        <div className="options-container">
          <h1 className="text-center mt-3 text-3xl font-bold">Cutlery</h1>
          <div className="search-filter">
            ...
            <div className="checkbox-group text-right mr-5">
              <label className="checkbox-label mr-2">
                <input
                  type="checkbox"
                  checked={selectedOptions.includes("Utensils")}
                  onChange={() => handleCheckboxChange("Utensils")}
                />
                Utensils
              </label>
              <label className="checkbox-label mr-2">
                <input
                  type="checkbox"
                  checked={selectedOptions.includes("Knives")}
                  onChange={() => handleCheckboxChange("Knives")}
                />
                Knives
              </label>
              <label className="checkbox-label mr-2">
                <input
                  type="checkbox"
                  checked={selectedOptions.includes("Glasses")}
  ...
  {filteredProducts
    .filter((product) => product.id >= 12 && product.id <= 19)
    .map((product) => (
